...
void RHS(Grid &RHS, Grid &F, Grid &G, float dx, float dy, float dt){
    for(int i = 0; i < RHS.i_max + RHS.i_g; i++){ // is the range correct? --> no
        for(int j = 0; j < RHS.j_max + RHS.j_g; j++){ // is the range correct? --> no
...
void residual(Grid &r, Grid &p, Grid &RHS, float dx, float dy){
    ...
    for(int i = 0; i < r.i_max + r.i_g; i++){ // is the range correct? --> no
        for(int j = 0; j < r.j_max + r.j_g; j++){ // is the range correct? --> no
